...
- Есть несколько типов врагов, разного уровня сложности. При столкновении персонажа и врага осуществляется отрисовка экрана боя. При проигрыше отрисовывается соответствующий экран, с кнопками "Вернуться в главное меню", или "Загрузить сохранённую игру". При выигрыше персонаж передвигается на место врага, клетка перестаёт быть "враждебной", становясь обычным полем. Игра продолжается с сохранением прогресса.
