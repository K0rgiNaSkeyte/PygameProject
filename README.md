...
## 1. Цель проекта.
Создание простой игры на клеточном поле с тремя уровнями. Создание главного меню, экрана проигрыша, выигрыша, настроек, итогового счёта, боя. Пользователь может загружать прогресс прохождения и загружать. Создание системы очков.
